...
public class uploader extends AppCompatActivity implements View.OnClickListener {
    ...
    private String UPLOAD_URL ="http://192.168.43.133/mh/uploaded.php";

    private String KEY_IMAGE = "image";
    private String KEY_NAME = "name";
    private String KEY_DUDE = "dude";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = new PrefManager(getApplicationContext());
         freak = pref.get_name();
        KEY_NAME=getIntent().getStringExtra("id");
